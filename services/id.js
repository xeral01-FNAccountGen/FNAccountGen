...
const CheckT = require("../rocket_data/other/CT")
...
app.get("/fortnite/api/cloudstorage/system", (req, res) => {
    ...
    var files = fs.readdirSync(`${__dirname}/../rocket_data/hotfixes/`)

    files = files.map(x => {
        var file = fs.readFileSync(`${__dirname}/../rocket_data/hotfixes/${x}`)
        ...
        return {
            ...
            uploaded: fs.statSync(`${__dirname}/../rocket_data/hotfixes/${x}`).mtime,
            storageType: "S3",
            doNotCache: false
        }
    })
...
app.get("/fortnite/api/cloudstorage/system/:filename", (req, res) => {
    ...
    res.sendFile(path.join(__dirname, `/../rocket_data/hotfixes/${reversed[req.params.filename]}`))
})
...
app.get("/content/api/pages/fortnite-game", async (req, res) => {
	...
	"battleroyalenewsv2": {
		"news": {
			"motds": [{
				"entryType": "Website",
				"image": "https://rocketfps.herokuapp.com/img/thingy.jpg",
				"tileImage": "https://rocketfps.herokuapp.com/img/thingy.jpg",
				"hidden": false,
				"videoMute": false,
				"tabTitleOverride": "Rocket",
				"_type": "CommonUI Simple Message MOTD",
				"body": "Welcome To Rocket, Made By Sky, GD, Zinx, Mjay, !rish",
				"title": "Rocket",
				"videoLoop": false,
				...
				"id": `Cloud-News-0`,
				"spotlight": false,
				"websiteURL": "https://discord.gg/rocketfn",
				"websiteButtonText": "Rocket Discord Server"
			}]
		},
		"jcr:isCheckedOut": true,
...
app.get("/fortnite/api/storefront/v2/keychain", (req, res) => {
    res.json(JSON.parse(fs.readFileSync(`${__dirname}/../rocket_data/other/keychain.json`)))
})
