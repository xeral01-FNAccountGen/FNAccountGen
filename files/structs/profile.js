...
module.exports = {
    ...
    async athena(id) {
        ...
        const cosmetics = JSON.parse(fs.readFileSync(`${__dirname}/../../rocket_data/items/cosmetics.json`))
        const variants = JSON.parse(fs.readFileSync(`${__dirname}/../../rocket_data/items/variants.json`))
